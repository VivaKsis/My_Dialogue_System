...
{
	[NodeAttributes("FlowReactor/Variables/Compare", "CompareString", "flowNodeColor", 2, NodeAttributes.NodeType.Normal)]
	public class CompareString : Node
	{
		
		public FRString compare;
		public FRString with;
