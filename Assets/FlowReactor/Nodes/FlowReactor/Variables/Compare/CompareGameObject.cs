...
{
	[NodeAttributes("FlowReactor/Variables/Compare", "CompareGameObject", "flowNodeColor", 2, NodeAttributes.NodeType.Normal)]
	public class CompareGameObject : Node
	{
		
		public FRGameObject compare;
		public FRGameObject with;
