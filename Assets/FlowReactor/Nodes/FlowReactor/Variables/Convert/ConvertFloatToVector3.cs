...
{
	[NodeAttributes( "FlowReactor/Variables/Convert" , "Convert float value to vector3" , "actionNodeColor" , 1 )]
	public class ConvertFloatToVector3 : Node
	{
		
		public FRFloat valueX;
		public FRFloat valueY;
		public FRFloat valueZ;
		[Title("Covert to vector3:")]
