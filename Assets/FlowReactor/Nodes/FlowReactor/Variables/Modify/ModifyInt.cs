...
{
	[NodeAttributes("FlowReactor/Variables/Modify", "ModifyInt", "actionNodeColor", 1, NodeAttributes.NodeType.Normal)]
	public class ModifyInt : Node
	{
		
		public FRInt value;
		public FRInt modifyWith;
