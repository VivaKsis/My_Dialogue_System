...
{
	[NodeAttributes( "Databox" , "Load Databox object" , "actionNodeColor" , 1 , NodeAttributes.NodeType.Normal )]
	public class LoadDatabox : Node
	{
		...
		public override void OnExecute(FlowReactorComponent _flowReactor)
		{
			...
			{
				databoxObject.LoadDatabase(customFileName);
			}
			else
			{
