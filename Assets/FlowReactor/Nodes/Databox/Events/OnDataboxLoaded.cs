...
{
	[NodeAttributes( "Databox/Events" , "Called after databox object has been loaded" , "eventNodeColor" , 1 , NodeAttributes.NodeType.Event )]
	public class OnDataboxLoaded : Node
	{
