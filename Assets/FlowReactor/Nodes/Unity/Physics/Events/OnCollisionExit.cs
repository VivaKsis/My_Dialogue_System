...
{
	[NodeAttributes("Unity/Physics/Events", "On Collision Exit", "eventNodeColor", 1, NodeAttributes.NodeType.Event)]
	public class OnCollisionExit : Node
	{
		...
		public override void OnInitialize(FlowReactorComponent _flowReactor)
		{
			...
			if (listener.Value != null)
			{
				...
				if (_go != null)
				{
					var _component = _go.GetComponent<CollisionExitListener>();
					if (_component != null)
					{
					...
					{
						_go.AddComponent<CollisionExitListener>().collisionTriggers.Add(this);
					}
				}
			}
		}
