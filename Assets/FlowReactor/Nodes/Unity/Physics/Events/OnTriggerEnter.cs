...
{
	[NodeAttributes("Unity/Physics/Events", "On Trigger Enter", "eventNodeColor", 1, NodeAttributes.NodeType.Event)]
	public class OnTriggerEnter : Node
	{
		...
		public override void OnInitialize(FlowReactorComponent _flowReactor)
		{
			...
			if (listener.Value != null)
			{
				...
				if (_go != null)
				{
					var _component = _go.GetComponent<TriggerEnterListener>();
					if (_component != null)
					{
					...
					{
						_go.AddComponent<TriggerEnterListener>().collisionTriggers.Add(this);
					}
				}
			}
		}
