...
[CustomPropertyDrawer(typeof(FrameTextSelectionAttribute))]
public class FrameTextSelectionAttributeDrawer : PropertyDrawer
{
	...
	public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
	{
		...
		if (GUI.Button(buttonRect, buttonLabel))
		{
			...
			for (int i = 0; i < guids.Length; i++)
			{
				...
				if (frame != null && frame.GetComponent<FrameText>() != null)
				{
