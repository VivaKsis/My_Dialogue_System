...
[CustomPropertyDrawer(typeof(FrameCollocutorNameSelectionAttribute))]
public class FrameCollocutorNameSelectionAttributeDrawer : PropertyDrawer
{
	private const string SELECT_FRAME_BUTTON_LABEL_TAG = "Select Name Frame",
	...
	public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
	{
		...
		if (GUI.Button(buttonRect, buttonLabel))
		{
			...
			for (int i = 0; i < guids.Length; i++)
			{
				...
				if (frame != null && frame.GetComponent<FrameCollocutorName>() != null)
				{
